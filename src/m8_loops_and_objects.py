...
def draw_circles1():
    ...
    window = rg.RoseWindow(400, 400, 'window')

    n = 21
    x = 0
    for k in range(n):
        center_point = rg.Point(200, 200)
        circles1 = rg.Circle(center_point, x)
...
def draw_circles2():
    ...
    for k in range(n):
        ...
        circles2 = rg.Circle(center_point, 10)
        circles2.fill_color = 'blue'
...
def draw_circles3():
    ...
    window = rg.RoseWindow(300, 300, 'window')

    n = 100
    x = 1
    for k in range(n):
        center_point = rg.Point(200, 150)
        circles3 = rg.Circle(center_point, x)
        circles3.attach_to(window)
        x = x + 1
...
def draw_cosines_and_sines():
    ...
    y = 0
    for k in range(n):
        center_point = rg.Point(200 + (80 * math.cos(x)), 200 + (80 * math.sin(y)))
        circles4 = rg.Circle(center_point, 10)
        circles4.attach_to(window)
        x = x + 1
        y = y + 1
